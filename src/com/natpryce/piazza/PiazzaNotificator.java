...
/**
 * We use the {@link Notificator} to generate input fields on the user settings
...
public class PiazzaNotificator implements Notificator {
    ...
    @Override
    public void notifyBuildProblemResponsibleAssigned(Collection<BuildProblemInfo> clctn, ResponsibilityEntry re, SProject sp, Set<SUser> set) {
    }

    @Override
    public void notifyBuildProblemResponsibleChanged(Collection<BuildProblemInfo> clctn, ResponsibilityEntry re, SProject sp, Set<SUser> set) {
    }

    @Override
    public void notifyBuildProblemsMuted(Collection<BuildProblemInfo> clctn, MuteInfo mi, Set<SUser> set) {
    }

    @Override
    public void notifyBuildProblemsUnmuted(Collection<BuildProblemInfo> clctn, MuteInfo mi, SUser suser, Set<SUser> set) {
    }
}
