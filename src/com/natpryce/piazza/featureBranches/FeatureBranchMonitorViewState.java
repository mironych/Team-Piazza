...
public class FeatureBranchMonitorViewState {
    ...
    private SortedMap<SBuildType, BuildTypeWithLatestBuildMonitorViewState> buildTypeWithLatestBuildViewState = new TreeMap<>();
    ...
    public Collection<BuildTypeWithLatestBuildMonitorViewState> getBuildTypes() {
        List<BuildTypeWithLatestBuildMonitorViewState> buildTypesWithBuild = new ArrayList<>();
